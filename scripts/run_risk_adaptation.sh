...
# ============================================
# Run risk adaptation analysis with sleep prevention
# ============================================

PROJECT_DIR="$HOME/Desktop/CMML3/ICA1/scripts"
LOG_DIR="$PROJECT_DIR/logs"
SCRIPT_NAME="run_risk_adaptation.R"
LOG_FILE="$LOG_DIR/risk_adaptation.log"
PID_FILE="$LOG_DIR/risk_adaptation.pid"
...
{
  echo "=========================================="
  echo "Starting risk adaptation run at: $(date)"
...
{
  echo "Launched risk adaptation job with PID: $RISK_PID"
  echo "Logs: $LOG_FILE"
  echo "=========================================="
